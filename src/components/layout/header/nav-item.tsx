...
const NavItem: FC<NavItemProps> = ({ href, text }) => {
    return (
      <Link
        href={href}
        className="relative group text-xl font-medium flex items-center overflow-hidden pr-3 text-secondaryColor"
      >
        <span className="absolute left-0 -translate-x-full group-hover:translate-x-0 transform transition-transform duration-300">
            <Image src="/assets/right-arrow.svg" alt="arrow-icon" width={30} height={30} />
        </span>
